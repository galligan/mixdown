...
![Sample responses from four different LLMs](./20250324-mixdown-sample-stacked.jpg)
...
A full reference for Mixdown's syntax and grammar can be found in [mixdown-syntax-reference.md](./mixdown-syntax-reference.md).
