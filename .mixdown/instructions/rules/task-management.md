...
4. ✅ ALWAYS use this format for tasks:
   ...
   ```md
   - [ ] Task: [Task Description] ([ref](path/to/related-file.md))
     - [ ] Subtask: [Subtask Description]
     - [x] Subtask: [Subtask Description] (completed 2025-04-18T12:00:00-04:00)
   ```
...
- [ ] Task: Implement database schema
  - [ ] Subtask: Create API endpoints for data access
- [ ] Task: Update project documentation

## 🟢 Completed

- [x] Task: Configure environment variables (completed 2025-04-18T12:00:00-04:00)
```
...
- [ ] Task: Create API endpoints for data access
  - [x] Subtask: Create API endpoints for data access (completed 2025-04-18T12:00:00-04:00)
- [ ] Task: Update project documentation

## 🟢 Completed

- [x] Task: Set up project structure (completed 2025-04-18T12:00:00-04:00)
...
- [x] Task: Implement database schema (completed 2025-04-18T12:00:00-04:00)
  - [x] Subtask: Create API endpoints for data access (completed 2025-04-18T12:00:00-04:00)
- [x] Task: Set up project structure (completed 2025-04-18T12:00:00-04:00)
  - Notes: Created the initial project directory structure including `src/`, `tests/`, and `docs/` folders.
- [x] Task: Configure environment variables (completed 2025-04-18T12:00:00-04:00)
