---
description: Use these rules when using the terminal
globs: 
alwaysApply: true
---
...
- ✅ For git commands, first check the [agent version control rules](mdc:.cursor/rules/agent-version-control.mdc)